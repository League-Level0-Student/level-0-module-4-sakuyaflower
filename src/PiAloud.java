...
public class PiAloud {
	public static void main(String[] args) {
		...
		String pi = "3.14159265358979323846264338327950288419716939937510582097494459230781640628620899862803482534211706798214808651328230664709384";
		...
		for (int i = 0; i < pi.length(); i++) {
			...
			if (pi.charAt(i) == answer) {
				System.out.println("Ur not an idiot XD");
			}
			else {
